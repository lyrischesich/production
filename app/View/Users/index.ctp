<?php echo $this->element('actions', array( 'actions' => $actions)); ?>
	...
	<tr>
		...
		<td class="actions">
			...
			&nbsp;|&nbsp;
			<?php echo $this->Form->postLink(' Löschen', array('controller' => 'users', 'action' => 'delete', $user['User']['id']), null, 'Wollen Sie wirklich den Benutzer "'.$user['User']['username'].'" löschen?', ''); ?>
		</td>
	</tr>
<?php	 endforeach; ?>
	</table>
